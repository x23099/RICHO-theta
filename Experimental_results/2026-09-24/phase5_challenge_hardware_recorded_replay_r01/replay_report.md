...
- replay rate: `30.0 Hz`
- expected output mode: `hardware`
- freshness mode: `challenge`
- physical output acknowledged: `True`
...
本結果は、録画済みriskからCollisionFfbPublisherBridge、ROS topic、hardware adapter、G923物理出力要求、status記録までを対象とする。G923の体感は自動判定しない。
