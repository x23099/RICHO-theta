            ...
            if os.path.exists(path):
                try:
                    ...
                    with open(path, "r") as f:
                        ...
                        print(f"[INFO] Loaded camera config from {path}: height={self.camera_height}, pitch={self.camera_pitch_deg}, offset_x={self.car_offset_x}, offset_z={self.car_offset_z}")
                        break
                except Exception as e:
                    print(f"[WARN] Failed to load camera config from {path}: {e}")
